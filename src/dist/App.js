...
var signalRAspNetCoreHelper_1 = require("./lib/signalRAspNetCoreHelper");
var App = /** @class */ (function (_super) {
    ...
    App.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.props.sessionStore.getCurrentLoginInformations()];
                    case 1:
                        _a.sent();
                        if (!!this.props.sessionStore.currentLogin.user && this.props.sessionStore.currentLogin.application.features['SignalR']) {
                            if (this.props.sessionStore.currentLogin.application.features['SignalR.AspNetCore']) {
                                signalRAspNetCoreHelper_1["default"].initSignalR();
                            }
                        }
                        return [2 /*return*/];
                }
    ...
    App.prototype.render = function () {
        return React.createElement(Router_1["default"], null);
    };
    App = __decorate([
