            ...
            react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement(antd_1.Row, { gutter: 16 },
                    ...
                    react_1["default"].createElement(antd_1.Col, { xs: { span: 24, offset: 2 }, sm: { span: 10, offset: 2 } },
                        ...
                        react_1["default"].createElement(antd_1.Steps, { direction: "vertical" }, data !== undefined && data.map(function (record) { return react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Step, { key: react_uuid_1["default"](), status: (record.status === status_1["default"].Apporved) ? "finish" : (record.status === status_1["default"].Waiting ? "wait" : "error"), title: talepDurumu_1["default"][record.talepDurumuStr], description: react_1["default"].createElement(react_1["default"].Fragment, null,
