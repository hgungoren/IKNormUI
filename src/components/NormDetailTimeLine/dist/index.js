                ...
                react_1["default"].createElement(antd_1.Row, { gutter: 16 },
                    react_1["default"].createElement(antd_1.Col, { xs: { span: 24, offset: 0 }, sm: { span: 12, offset: 0 } },
                        react_1["default"].createElement(antd_1.Descriptions, { column: 1, key: react_uuid_1["default"](), size: 'small', title: abpUtility_1.L("RequestDetail"), bordered: true }, norm !== undefined && react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(antd_1.Descriptions.Item, { key: 'area_name' + norm.id, label: abpUtility_1.L("table.norm.area.name") }, norm.bolgeAdi),
                            react_1["default"].createElement(antd_1.Descriptions.Item, { key: 'branch_name' + norm.id, label: abpUtility_1.L("table.norm.branch.name") }, norm.subeAdi),
                            ...
                            norm.nedeni !== '' && react_1["default"].createElement(antd_1.Descriptions.Item, { key: react_uuid_1["default"](), label: abpUtility_1.L("table.norm.requestreason") },
                                " ",
                                abpUtility_1.L(norm.nedeni),
                                " "),
                            ...
                            react_1["default"].createElement(antd_1.Descriptions.Item, { key: react_uuid_1["default"](), label: abpUtility_1.L("table.norm.requestdate") }, react_1["default"].createElement(DateCart_1["default"], { date: norm.creationTime })),
                    ...
                    react_1["default"].createElement(antd_1.Col, { xs: { span: 24, offset: 2 }, sm: { span: 10, offset: 2 } },
                        ...
                        react_1["default"].createElement(antd_1.Steps, { direction: "vertical" }, data !== undefined && data.map(function (record, index) { return react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Step, { key: index, status: (record.status === status_1["default"].Apporved) ? "finish" : (record.status === status_1["default"].Waiting ? "wait" : "error"), title: talepDurumu_1["default"][record.talepDurumuStr], description: react_1["default"].createElement(react_1["default"].Fragment, null,
                                    ((record.lastModificationTime !== null && record.status !== status_1["default"].Waiting) && react_1["default"].createElement(DateCart_1["default"], { date: record.lastModificationTime })),
