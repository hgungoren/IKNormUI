...
function KCartList(_a) {
    ...
    setTimeout(function () {
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getcancelednormupdaterequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getcancelednormupdaterequest')) {
            setCanceledNormUpdateRequest(getCanceledNormUpdateRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getacceptednormupdaterequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getacceptednormupdaterequest')) {
            setAcceptedNormUpdateRequest(getAcceptedNormUpdateRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getpendingnormupdaterequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getpendingnormupdaterequest')) {
            setPendingNormUpdateRequest(getPendingNormUpdateRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.gettotalnormupdaterequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.gettotalnormupdaterequest')) {
            setTotalNormUpdateRequest(getTotalNormUpdateRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getcancelednormfillrequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getcancelednormfillrequest')) {
            setCanceledNormFillRequest(getCanceledNormFillRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getacceptednormfillrequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getacceptednormfillrequest')) {
            setAcceptedNormFillRequest(getAcceptedNormFillRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.getpendingnormfillrequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.getpendingnormfillrequest')) {
            setPendingNormFillRequest(getPendingNormFillRequestCount);
        }
        if (abpUtility_1.isGranted('subitems.kareas.infobox.gettotalnormfillingrequest') || abpUtility_1.isGranted('subitems.dashboard.infobox.gettotalnormfillingrequest')) {
