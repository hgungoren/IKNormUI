...
var NotificationDrawer = /** @class */ (function (_super) {
    ...
    function NotificationDrawer() {
        ...
        _this.componentDidMount = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getNotifications()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        _this.content = function () {
            return react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement(antd_1.Space, { style: { width: '100%' }, direction: "vertical" },
                    react_1["default"].createElement("div", null, abpUtility_1.L('d'))));
        };
        return _this;
    }
    NotificationDrawer.prototype.render = function () {
        var _a = this.props, visible = _a.visible, showOrHideDrawer = _a.showOrHideDrawer;
        return (react_1["default"].createElement(antd_1.Drawer, { width: 500, 
            // footer={     }
