'use strict';
const { getCookie, removeCookie } = require('@helpers/cookie');
...
var _authorization = getCookie('token');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            var entitiyQuery = ""
            if (options.modelId) {
              entitiyQuery += "?entityId=" + options.modelId
            }
            if (options.modelName) {
              entitiyQuery += "&typeName=" + options.modelName
            }
            route = options.apiRoot + "/files/entities" + entitiyQuery
            method = 'GET';
            _context2.next = 4;
            return (0, _superagent2.default)(method, route).set({ authorization: _authorization });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            return _context3.abrupt('return', response.body.data.map(_common.normalizeResource));
...
var uploadFileToId = function () {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            // alttaki kod klasör yapısı upload işlemi için bu olayı field('parentId',parentId) şeklinde sağlamaktadır. 
            ...
            return _context9.abrupt('return', _superagent2.default.post(route)
              .send({
                parentId: apiOptions.modelId,
                parentType: apiOptions.modelName,
                fileName: fileName,
                name: fileName,
                extension: extension,
              ...
              .set({ authorization: _authorization, 'Content-Type': 'application/json' }));
  ...
  return function uploadFileToId(_x25, _x18) {
...
var downloadResources = function () {
  var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(_ref13) {
    ...
    var route, method, response;
    var options = _ref13.apiOptions;
    var resourceId = _ref13.id;
    return _regenerator2.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            route = options.apiRoot + "/files/download/" + resourceId;
            method = 'GET';
            _context10.next = 4;
            return (0, _superagent2.default)(method, route).set({ authorization: _authorization });
          ...
          case 4:
            ...
            return _context10.abrupt('return', response.body);
  ...
  //       switch (_context10.prev = _context10.next) {
  //         case 0:
  //           downloadUrl = apiOptions.apiRoot + resources[0].downloadLink
  //           _context10.next = 3;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            method = 'DELETE';
            return _context13.abrupt('return', (0, _superagent2.default)(method, route).set({ authorization: _authorization }));
