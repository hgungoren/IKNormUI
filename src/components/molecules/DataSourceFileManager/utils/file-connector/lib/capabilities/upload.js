...
var _handler = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(apiOptions, actions, data) {
    ...
    return _regenerator2.default.wrap(async function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            return _api2.default.uploadFileToId({ apiOptions: apiOptions, parentId: resource.id, file: window.btoa(result), fileName: file.name, onProgress: onProgress, contentType: file.type, extension: "." + file.name.split('.').pop() });
