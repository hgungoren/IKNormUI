...
exports.userRouter = [
    { path: '/user', name: 'User', title: 'User', component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../components/Layout/UserLayout'); }); }), showInMenu: false, isLayout: true },
...
exports.appRouters = [
    ...
    { path: '/home', permission: '', title: 'Home', name: 'Home', icon: icons_1.UserOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/Home'); }); }) },
    ...
    { path: '/khierarchytransfer', permission: 'items.hierarchy.menu.view', title: 'Hierarchy Transfer', name: 'HierarchyTransfer', icon: icons_1.PartitionOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HierarchyTransfer'); }); }) },
    { path: '/ksube/:id', permission: 'subitems.kareas.table.areas.btn', title: 'KSube', name: 'KSube', icon: icons_1.TableOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSube'); }); }) },
    ...
    { path: '/hasartazmin', permission: 'htm', title: 'Tazmin Formu Oluştur', name: 'HasarTazmin', icon: icons_1.AimOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazmin'); }); }) },
    { path: '/hasartazminsorgulama', permission: 'htm', title: 'Tazmin Form Listesi', name: 'HasarTazmin Listesi', icon: icons_1.UnorderedListOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazminList'); }); }) },
    { path: '/hasartazminguncelle/:id', permission: 'htm', title: 'Hasar Tazmin Güncelle', name: 'HasarTazminguncelle', icon: icons_1.AimOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazmin/updateDamageCompensation'); }); }) },
];
