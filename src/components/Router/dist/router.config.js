...
exports.appRouters = [
    ...
    { path: '/bolgemudurluk', permission: 'items.branch.menu.view', title: 'KBolge', name: 'KBolge', icon: icons_1.TableOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KBolge'); }); }) },
    ...
    { path: '/home', permission: 'items.home.menu.view', title: 'Home', name: 'Home', icon: icons_1.InfoCircleOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/Home'); }); }) },
