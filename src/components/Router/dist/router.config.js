...
exports.appRouters = [
    ...
    { path: '/khierarchy', permission: 'khierarchy.edit', title: 'Hierarchy', name: 'Hierarchy', icon: icons_1.HomeOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/Hierarchy'); }); }) },
    { path: '/ksube/:id', permission: 'ksube.view', title: 'KSube', name: 'KSube', icon: icons_1.UserOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSube'); }); }) },
    { path: '/ksube/:id', permission: 'kbolge.branches', title: 'KSube', name: 'KSube', icon: icons_1.UserOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSube'); }); }) },
    { path: '/ksubedetay', permission: 'ksube.user.detail', title: 'KSube', name: 'KSube', icon: icons_1.UserOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSubeDetay'); }); }) },
    { path: '/ksubedetay/:id', permission: 'ksube.detail', title: 'KSubeDetay', name: 'KSubeDetay', icon: icons_1.UserOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSubeDetay'); }); }) },
    { path: '/ksubedetay/:id', permission: 'kbolge.detail', title: 'KSube', name: 'KSube', icon: icons_1.UserOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KSubeDetay'); }); }) },
    { path: '/bolgemudurluk', permission: 'kbolge.view', title: 'KBolge', name: 'KBolge', icon: icons_1.UserOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/KBolge'); }); }) },
    { path: '/users', permission: 'user.view', title: 'Users', name: 'Users', icon: icons_1.UserOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/Users'); }); }) },
