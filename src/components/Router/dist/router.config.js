...
exports.appRouters = [
    ...
    { path: '/hierarchytransfer', permission: 'items.hierarchy.menu.view', title: 'Hierarchy Transfer', name: 'HierarchyTransfer', icon: icons_1.PartitionOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HierarchyTransfer'); }); }) },
    ...
    { path: '/hasartazminsorgulama', permission: '', title: 'Hasar Tazmin Sorgulama', name: 'HasarTazmin Listesi', icon: icons_1.UnorderedListOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazminList'); }); }) },
    { path: '/hasartazminguncelle/:id', permission: '', title: 'Hasar Tazmin Güncelle', name: 'HasarTazminguncelle', icon: icons_1.AimOutlined, showInMenu: false, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazmin/updateDamageCompensation'); }); }) },
];
