...
exports.appRouters = [
    ...
    { path: '/hasartazmin', permission: 'items.damage.search.menu.view', title: 'Hasar Tazmin', name: 'HasarTazmin', icon: icons_1.AimOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/HasarTazmin'); }); }) },
