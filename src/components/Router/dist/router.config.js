...
exports.appRouters = [
    ...
    { path: '/hierarchy', permission: '', title: 'hierarchy', name: 'hierarchy', icon: icons_1.HomeOutlined, showInMenu: true, component: index_1["default"](function () { return Promise.resolve().then(function () { return require('../../scenes/Hierarchy'); }); }) },
