...
export const appRouters: any = [
  ...
  { path: '/bolgemudurluk',          permission: 'items.branch.menu.view',                title: 'KBolge',             name: 'KBolge',             icon: TableOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/KBolge')), },
