...
import { HomeOutlined, UserOutlined, TagsOutlined, AppstoreOutlined, PartitionOutlined, TableOutlined, UsergroupAddOutlined,AimOutlined } from '@ant-design/icons';
...
export const appRouters: any = [
  ...
  { path: '/home',                   permission: 'items.home.menu.view',          title: 'Home',                   name: 'Home',                 icon: UserOutlined ,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Home')), },
  ...
  { path: '/hasartazmin',            permission: 'items.damage.menu.view',        title: 'Hasar Tazmin',           name: 'HasarTazmin',          icon: AimOutlined,          showInMenu: true,  component: LoadableComponent(() => import('../../scenes/HasarTazmin')), },
