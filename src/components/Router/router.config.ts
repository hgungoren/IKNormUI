...
export const appRouters: any = [
  ...
  { path: '/khierarchy',             permission: 'khierarchy.edit',    title: 'Hierarchy',          name: 'Hierarchy',          icon: HomeOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Hierarchy')), },
  { path: '/ksube/:id',              permission: 'ksube.view',         title: 'KSube',              name: 'KSube',              icon: UserOutlined,        showInMenu: false, component: LoadableComponent(() => import('../../scenes/KSube')), },
  { path: '/ksube/:id',              permission: 'kbolge.branches',    title: 'KSube',              name: 'KSube',              icon: UserOutlined,        showInMenu: false, component: LoadableComponent(() => import('../../scenes/KSube')), },
  { path: '/ksubedetay',             permission: 'ksube.user.detail',  title: 'KSube',              name: 'KSube',              icon: UserOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/KSubeDetay')), },
  { path: '/ksubedetay/:id',         permission: 'ksube.detail',       title: 'KSubeDetay',         name: 'KSubeDetay',         icon: UserOutlined,        showInMenu: false, component: LoadableComponent(() => import('../../scenes/KSubeDetay')), },
  { path: '/ksubedetay/:id',         permission: 'kbolge.detail',      title: 'KSube',              name: 'KSube',              icon: UserOutlined,        showInMenu: false, component: LoadableComponent(() => import('../../scenes/KSubeDetay')), },
  { path: '/bolgemudurluk',          permission: 'kbolge.view',        title: 'KBolge',             name: 'KBolge',             icon: UserOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/KBolge')), },
  { path: '/users',                  permission: 'user.view',          title: 'Users',              name: 'Users',              icon: UserOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Users')), },
