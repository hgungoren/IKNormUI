...
<<<<<<< HEAD
  ...
  },
  {
    ...
    key: 'menu-item-13',
    permission: 'items.requestforpromotion.create.menu.view',
  ...
  {
    path: '/promotionconfirmotion/:id',
    key: 'menu-item-14',
    permission: 'items.requestforpromotion.create.menu.view',
    title: 'RequestForPromotion',
    type: 'hr',
    name: 'PromotionConfirmotion',
    icon: UsergroupAddOutlined,
    showInMenu: false,
    component: LoadableComponent(() => import('../../scenes/PromotionConfirmation')),
  },
  {
    path: '/requestforpromotionfilter',
    key: 'menu-item-15',
    permission: 'items.requestforpromotion.search.menu.view',
  ...
  },
  {
    ...
    key: 'menu-item-16',
    permission: 'items.requestforpromotion.report.menu.view',
