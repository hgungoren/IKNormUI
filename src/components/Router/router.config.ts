...
export const appRouters: any = [
  ...
  { path: '/dashboard',              permission: 'pages.dashboard.new',  title: 'Dashboard',          name: 'Dashboard',          icon: HomeOutlined,         showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Dashboard')), },
  { path: '/khierarchy',             permission: 'pages.hierarchy',      title: 'Hierarchy',          name: 'Hierarchy',          icon: PartitionOutlined,    showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Hierarchy')), },
  ...
  { path: '/ksubedetay',             permission: 'items.kbranch_detail.view',   title: 'KSube',              name: 'KSube',              icon: TableOutlined,        showInMenu: true,  component: LoadableComponent(() => import('../../scenes/KSubeDetay')), },
  { path: '/ksubedetay/:id',         permission: 'items.kbranch_detail.view',   title: 'KSubeDetay',         name: 'KSubeDetay',         icon: TableOutlined,        showInMenu: false, component: LoadableComponent(() => import('../../scenes/KSubeDetay')), },
  ...
  { path: '/users',                  permission: 'pages.user.new',       title: 'Users',              name: 'Users',              icon: UsergroupAddOutlined, showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Users')), },
  { path: '/roles',                  permission: 'pages.role.new',       title: 'Roles',              name: 'Roles',              icon: TagsOutlined,         showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Roles')), },
  ...
  { path: '/home',                   permission: 'items.home.view',      title: 'Home',               name: 'Home',               icon: InfoCircleOutlined,   showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Home')), },
