...
export const appRouters: any = [
  ...
  { path: '/users',                        key:'menu-item-12', permission: 'items.user.menu.view',              title: 'Users',                        type:'settings', name: 'Users',                        icon: UsergroupAddOutlined,       showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Users')), },
  { path: '/roles',                        key:'menu-item-13', permission: 'items.role.menu.view',              title: 'Roles',                        type:'settings', name: 'Roles',                        icon: TagsOutlined,               showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Roles')), }, 
  { path: '/logout',                       key:'menu-item-14', permission: '',                                  title: 'Logout',                       type:'',         name: 'Logout',                                                         showInMenu: false, component: LoadableComponent(() => import('../../components/Logout')), },
  { path: '/exception?:type',              key:'menu-item-15', permission: '',                                  title: 'Exception',                    type:'',         name: 'Exception',                                                      showInMenu: false, component: LoadableComponent(() => import('../../scenes/Exception')), },
  { path: '/knormrequestdetail/:id',       key:'menu-item-16', permission: 'kNormRequestDetail',                title: 'KNormRequestDetail',           type:'hr',       name: 'KNormRequestDetail',           icon: UserOutlined,               showInMenu: false, component: LoadableComponent(() => import('../../scenes/KNormRequestDetail')), },
  { path: '/hasartazmin',                  key:'menu-item-17', permission: '',                                  title: 'DamageCompensationForm',       type:'op',       name: 'HasarTazmin',                  icon: AimOutlined,                showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Ops/HasarTazmin')), }, 
  { path: '/hasartazminsorgulama',         key:'menu-item-18', permission: '',                                  title: 'DamageCompensationList',       type:'op',       name: 'HasarTazmin Listesi',          icon: UnorderedListOutlined ,     showInMenu: true,  component: LoadableComponent(() => import('../../scenes/Ops/HasarTazminList')), }, 
  { path: '/damageconmpensationview/:id',  key:'menu-item-19', permission: '',                                  title: 'DamageCompensationView',       type:'op',       name: 'DamageCompensationView',       icon: AimOutlined,                showInMenu: false, component: LoadableComponent(() => import('../../scenes/Ops/HasarTazmin/view')), }, 
