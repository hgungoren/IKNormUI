...
export const appRouters: any = [
  ...
  { path: '/hierarchytransfer',       permission: 'items.hierarchy.menu.view',         title: 'Hierarchy Transfer',     name: 'HierarchyTransfer',    icon: PartitionOutlined,     showInMenu: true,  component: LoadableComponent(() => import('../../scenes/HierarchyTransfer')), },
