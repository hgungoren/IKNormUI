...
var KHierarchyStore = /** @class */ (function () {
    function KHierarchyStore() {
    }
    KHierarchyStore.prototype.getAll = function (tip, id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, kHierarchyService_1["default"].getAll(tip, id)];
                    case 1:
                        result = _a.sent();
    ...
    KHierarchyStore.prototype.getUnit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, kHierarchyService_1["default"].getUnits()];
                    case 1:
                        result = _a.sent();
                        this.units = result;
    ...
    KHierarchyStore.prototype.update = function (changeStatus) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, kHierarchyService_1["default"].update(changeStatus)];
                    case 1:
                        result = _a.sent();
                        this.status = result;
                        return [2 /*return*/];
    ...
    KHierarchyStore.prototype.updateToPassive = function (changeToPassiveStatus) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, kHierarchyService_1["default"].updateToPassive(changeToPassiveStatus)];
                    case 1:
                        result = _a.sent();
                        this.status = result;
                        return [2 /*return*/];
    ...
    KHierarchyStore.prototype.updateOrderNodes = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        mobx_1.action
    ], KHierarchyStore.prototype, "getUnit");
    __decorate([
        mobx_1.action
    ], KHierarchyStore.prototype, "update");
    __decorate([
        mobx_1.action
    ], KHierarchyStore.prototype, "updateToPassive");
    __decorate([
        mobx_1.action
