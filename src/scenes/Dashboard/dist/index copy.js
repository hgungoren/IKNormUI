...
var Dashboard2 = /** @class */ (function (_super) {
    ...
    Dashboard2.prototype.getEmployeeCount = function () {
    ...
    Dashboard2.prototype.getNormCount = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Dashboard2.prototype.getNormRequests = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Dashboard2.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Dashboard2.prototype.parseDate = function (input) {
        var parts = input.match(/(\d+)/g);
        return new Date(parts[0], parts[1] - 1, parts[2]);
    };
    Dashboard2.prototype.addDays = function (days) {
        var futureDate = new Date();
        futureDate.setDate(futureDate.getDate() + days);
        return futureDate;
    };
    Dashboard2.prototype.render = function () {
