...
import EditOrViewIncoming from '../components/editOrViewIncoming';
  ...
  render() {
        ...
        render: (text: string, item: any) => (
          <div>
            <Dropdown
              ...
              overlay={
                <Menu>
                  <Menu.Item onClick={() => this.editOrViewIncomingModalOpen()}>
                    {L('Edit')}
                  </Menu.Item>
    ...
    return (
      <>
        <React.Fragment>
          <Card>
            <Divider orientation="left">Gelen Evrak İşlemleri</Divider>
            <Form
              {...layout}
              name="nest-messages"
