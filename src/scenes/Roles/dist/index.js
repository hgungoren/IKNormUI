            ...
            { title: abpUtility_1.L('table.role.description'), dataIndex: 'description', key: 'description', width: 150, render: function (text) { return React.createElement("div", null, text); }, responsive: ['sm'] },
            {
                ...
                render: function (text, item) { return (React.createElement("div", null,
                    React.createElement(antd_1.Dropdown, { trigger: ['click'], overlay: React.createElement(antd_1.Menu, null,
                            abpUtility_1.isGranted('subitems.role.table.create') && React.createElement(antd_1.Menu.Item, { key: 0, onClick: function () { return _this.showDrawer({ id: item.id }); } }, abpUtility_1.L('AddRole')),
                            abpUtility_1.isGranted('subitems.role.table.edit') && React.createElement(antd_1.Menu.Item, { key: 1, onClick: function () { return _this.createOrUpdateModalOpen({ id: item.id }); } }, abpUtility_1.L('Edit')),
                            abpUtility_1.isGranted('subitems.role.table.delete') && React.createElement(antd_1.Menu.Item, { key: 2, onClick: function () { return _this["delete"]({ id: item.id }); } }, abpUtility_1.L('Delete'))), placement: "bottomLeft" },
