...
import OpsHiearchyTransfer from  './compenents/OpsHiearchyTransfer';
import OpsHiearchySortable from './compenents/OpsHiearchySortable';
...
@observer
class OpsTransfer extends AppComponentBase<IProps, IState> {
  state = {
    keys: [], 
    selectedKeys: [], 
  };
          ...
          <Row gutter={[16, 16]}>
            ...
            >
              <OpsHiearchyTransfer
                ...
                opsHierarchyStore={this.props.opsHierarchyStore}
