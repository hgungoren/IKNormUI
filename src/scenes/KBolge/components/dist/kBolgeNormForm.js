...
var KBolgeNormForm = /** @class */ (function (_super) {
    __extends(KBolgeNormForm, _super);
    function KBolgeNormForm() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    KBolgeNormForm.prototype.render = function () {
        var formItemLayout = {
        ...
        return (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement(antd_2.Form, { ref: formRef },
                ...
                react_1["default"].createElement(antd_2.Form.Item, __assign({ label: abpUtility_1.L("NormCount") }, formItemLayout, { name: 'adet', rules: createNorm_validation_1["default"].adet }),
                    react_1["default"].createElement(antd_2.InputNumber, { min: 1, style: { minWidth: '100%' } })),
    ...
    return KBolgeNormForm;
}(react_1["default"].Component));
exports["default"] = KBolgeNormForm;
