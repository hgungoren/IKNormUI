...
var KBolgeNormTable = /** @class */ (function (_super) {
    ...
    KBolgeNormTable.prototype.render = function () {
        ...
        var columns = [
            { title: abpUtility_1.L('Position'), dataIndex: 'pozisyon', key: 'pozisyon', width: 150, render: function (text) { return react_1["default"].createElement("div", null, text); } },
            { title: abpUtility_1.L('NormCount'), dataIndex: 'adet', key: 'adet', width: 50, render: function (text) { return react_1["default"].createElement("div", null, text); } },
            { title: abpUtility_1.L('EmployeeCount'), dataIndex: 'adet', key: 'adet', width: 50, render: function (text) { return react_1["default"].createElement("div", null, text); } },
            {
        ...
        return (react_1["default"].createElement(react_1["default"].Fragment, null, abpUtility_1.isGranted('kbolge.norm.view') &&
            react_1["default"].createElement(antd_2.Table, { locale: { emptyText: abpUtility_1.L('NoData') }, rowKey: function (record) { return record.id.toString(); }, bordered: false, columns: columns, pagination: { pageSize: 5, total: norms === undefined ? 0 : norms.items.length, defaultCurrent: 1 }, loading: norms === undefined ? true : false, dataSource: norms === undefined ? [] : norms.items })));
    };
