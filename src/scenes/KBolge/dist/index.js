            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!(abpUtility_1.isGranted('subitems.kareas.infobox.getcancelednormupdaterequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.getacceptednormupdaterequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.getpendingnormupdaterequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.gettotalnormupdaterequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.getcancelednormfillrequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.getacceptednormfillrequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.getpendingnormfillrequest') ||
                            abpUtility_1.isGranted('subitems.kareas.infobox.gettotalnormfillingrequest'))) return [3 /*break*/, 7];
            ...
            { title: abpUtility_1.L('table.area.normgap'), dataIndex: 'normEksigi', key: 'normEksigi', width: 150, render: function (text) { return React.createElement("div", null, text); }, responsive: ['sm'] },
            {
                ...
                render: function (text, bolge) { return (React.createElement("div", null,
                    React.createElement(antd_1.Dropdown, { trigger: ['click'], overlay: React.createElement(antd_1.Menu, null,
                            abpUtility_1.isGranted('subitems.kareas.table.unit.detail.btn') && (React.createElement(antd_1.Menu.Item, null,
                                " ",
                                React.createElement(react_router_dom_1.Link, { to: { pathname: "/ksubedetay/" + bolge.objId, state: { subeAdi: bolge.adi } } },
                                    ...
                                    " "),
                                " ")),
                            abpUtility_1.isGranted('subitems.kareas.table.areas.btn') && (React.createElement(antd_1.Menu.Item, { key: "/ksube" },
                                " ",
                                React.createElement(react_router_dom_1.Link, { to: { pathname: "/ksube/" + bolge.objId, state: { name: bolge.adi, tipTur: bolge.tipTur, tip: bolge.tip } } },
                                    ...
                                    " "),
                                " ")),
                            abpUtility_1.isGranted('subitems.kareas.table.norm.entry.btn') && (React.createElement(antd_1.Menu.Item, null,
                                " ",
            ...
            this.isGranted('subitems.kareas.table.view') && React.createElement(antd_1.Card, { hoverable: true },
                ...
                React.createElement(antd_1.Row, { style: { marginTop: 20 } },
                    React.createElement(antd_1.Col, { xs: { span: 24, offset: 0 }, sm: { span: 24, offset: 0 }, md: { span: 24, offset: 0 }, lg: { span: 24, offset: 0 }, xl: { span: 24, offset: 0 }, xxl: { span: 24, offset: 0 } },
                        React.createElement(antd_1.Table, { bordered: false, columns: columns, pagination: tablePagination, onChange: this.handlePagination, locale: { emptyText: abpUtility_1.L('NoData') }, rowKey: function (record) { return record.objId.toString(); }, loading: kBolge === undefined ? true : false, dataSource: kBolge === undefined ? [] : kBolge.items })))),
            React.createElement(createKBolgeNorm_1["default"], { modalType: 'create', formRef: this.formRef, positionSelect: positions, normList: this.state.normList, subeObjId: this.state.subeObjId, visible: this.state.modalVisible, kSubeNormEdit: this.kSubeNormEdit, kSubeNormCreate: this.kSubeNormCreate, kSubeNormDelete: this.kSubeNormDelete, kPosizyonKontrol: this.kPosizyonKontrol, kSubeNormStore: this.props.kSubeNormStore, kSubeNorms: this.props.kSubeNormStore.norms, onCancel: function () { _this.setState({ modalVisible: false }); } })));
    };
    KBolge = __decorate([
