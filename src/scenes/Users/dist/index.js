...
var User = /** @class */ (function (_super) {
    ...
    User.prototype.render = function () {
        ...
        var columns = [
            { title: abpUtility_1.L('table.user.username'), dataIndex: 'userName', key: 'userName', width: 100, render: function (text) { return React.createElement("div", null, text); } },
            { title: abpUtility_1.L('table.user.name'), dataIndex: 'name', key: 'name', width: 100, render: function (text) { return React.createElement("div", { className: "firstname" }, text); } },
            { title: abpUtility_1.L('table.user.surname'), dataIndex: 'surname', key: 'surname', width: 100, render: function (text) { return React.createElement("div", { className: "surname" }, text); } },
            { title: abpUtility_1.L('table.user.duty'), dataIndex: 'title', key: 'title', width: 150, render: function (text) { return React.createElement("div", null, text); } },
            { title: abpUtility_1.L('table.user.email'), dataIndex: 'emailAddress', key: 'emailAddress', width: 150, render: function (text) { return React.createElement("div", null, text); } },
            {
                title: abpUtility_1.L('table.user.status'),
                dataIndex: 'isActive',
                key: 'isActive',
                width: 50,
                render: function (text) { return (text === true ? React.createElement(antd_1.Tag, { color: "#2db7f5" }, abpUtility_1.L('Active')) : React.createElement(antd_1.Tag, { color: "red" }, abpUtility_1.L('Passive'))); }
            },
            {
